...
class TestUtils:
    ...
    def test_printer_real_with_zero(self):
        printer = utils.ArrayPrinter(
            np.array([
                [0, 2, 3],
                [4, 0, 6],
    ...
    def test_printer_imag_with_zero(self):
        printer = utils.ArrayPrinter(
            np.array([
                [0 + 0j, 2 + 2j, 3 + 3j],
                [4 + 4j, 0 + 0j, 6 + 6j],
        ...
        assert str(printer) == \
            "                0 +2.0e+00+2.0e+00j +3.0e+00+3.0e+00j \n" + \
            "+4.0e+00+4.0e+00j                 0 +6.0e+00+6.0e+00j \n" + \
            "+7.0e+00+7.0e+00j +8.0e+00+8.0e+00j                 0 \n"
