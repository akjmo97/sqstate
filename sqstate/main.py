...
def mock_process():
    ...
    reduce_lr = ReduceLROnPlateau(
        monitor='loss', factor=0.7, patience=5, mode='auto', min_delta=0.0000001, cooldown=10, min_lr=0.0000005, verbose=1
    )
    ...
    homodyne_time1 = Conv1D(64, 1, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time1 = Conv1D(64, 4, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time3 = Conv1D(64, 1, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time3 = Conv1D(64, 4, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time5 = Conv1D(64, 1, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time5 = Conv1D(64, 4, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time7 = Conv1D(64, 1, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time7 = Conv1D(64, 4, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time9 = Conv1D(64, 1, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    homodyne_time9 = Conv1D(64, 4, strides=1, padding="same", kernel_initializer=tf.random_normal_initializer(stddev=0.001),
    ...
    return example_result_if.shape
